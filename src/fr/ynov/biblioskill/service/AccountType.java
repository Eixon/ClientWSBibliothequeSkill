...
public class AccountType implements java.io.Serializable {
    ...
    public static final java.lang.String _ACTIF = "ACTIF";
    public static final java.lang.String _BLOQUE = "BLOQUE";
    public static final AccountType ACTIF = new AccountType(_ACTIF);
    public static final AccountType BLOQUE = new AccountType(_BLOQUE);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://service.biblioskill.ynov.fr/", "accountType"));
    }
    /**
